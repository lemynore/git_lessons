...
public class MtsByTests {
    ...
    @Description("Проверка отображения корректных надписей в пустых полях каждого варианта оплаты услуг")
    ...
    @Test
    @Feature("Онлайн пополнение")
    @Story("Проверка оплаты 'Услуги связи'")
    @Description("Заполнение полей для оплаты 'Услуги связи' и проверка корректности отображения информации")
